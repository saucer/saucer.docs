...
Saucer supports the HTML Attributes `data-webview-drag` and `data-webview-resize` which can be used to conveniently add support for custom drag areas or resize-handles.
